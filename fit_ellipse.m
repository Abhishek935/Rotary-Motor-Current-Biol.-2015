...
%                      'Pointoncurve1',Pointoncurve1,... - added by P. Lele.
%                      'Pointoncurve2',Pointoncurve2,... - added by P. Lele.
%                       these are the two points where the long axis meets the
%                       curve
...
%    ----------------------------------------
% Added by Lele
     X1=[X0+a;Y0];Y1=[X0;Y0+b];
     X2=[X0-a;Y0];Y2=[X0;Y0-b];
     if a>b
        Pointoncurve1      = R * X1;
        Pointoncurve2      = R * X2;
     else
...
%    ----------------------------------------
    ...
    ellipse_t = struct( ...
        ...
        'Pointoncurve1',Pointoncurve1,...
        'Pointoncurve2',Pointoncurve2,...
        'status','' );
else
